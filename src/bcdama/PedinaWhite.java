 ...
 * @author ale2s_000
 */
public class PedinaWhite extends PedinaGeneral {
    ...
    public void setPedinaCharAssociated(PedinaChar pedinaCharAssociated) {
     ...
     PedinaWhite(int color, BCDamaGraphic bcdg, PedinaChar pedinaCharAssociated, int w, int h, String img) {
        super(w, h, img);
        this.color = color;
        this.bcdg = bcdg;
        this.pedinaCharAssociated = pedinaCharAssociated;
    ...
    if(this.pedinaCharAssociated.getType()==PedinaChar.PEDINA) setEatedAnimation(10, 13, pt, 0.35d, false,100,MoveAnimePedinaTimer.BITE);
    else setEatedAnimation(7, 11, pt, 0.4d, false,100,MoveAnimePedinaTimer.BITE);
    }
    ...
    public void setMoveAnimation(ParallelTransition parallelTransition, double frac, boolean ciclyc) {
            ...
            if (pedinaCharAssociated.getType() == pedinaCharAssociated.PEDINA) {
                t = new MoveAnimePedinaTimer(5, 6, this, parallelTransition, frac, ciclyc, 100,MoveAnimePedinaTimer.MOVEWHITE );
            } else {
                t = new MoveAnimePedinaTimer(1, 2, this, parallelTransition, frac, ciclyc, 100,MoveAnimePedinaTimer.DAMAMOVE_W);
                //t = new MoveAnimePedinaTimer(5, 6, this, parallelTransition, frac, ciclyc, 100,MoveAnimePedinaTimer.DAMAMOVE_W);
            }
    ...
    public void setMoveEatAnimation(ParallelTransition parallelTransition, double frac, boolean ciclyc) {
            t = new MoveAnimePedinaTimer(2, 3, this, parallelTransition, frac, ciclyc, 100,MoveAnimePedinaTimer.FIRE);
    ...
    if (pedinaCharAssociated.getType() == PedinaChar.PEDINA) {
        frameImages = new Image("pedinaNeraAnimBattagliaDama.png");
